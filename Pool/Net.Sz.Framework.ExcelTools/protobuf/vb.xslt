...
-->Public class <xsl:call-template name="pascal"/>
...
End Class
  ...
  <xsl:if test="$optionAsynchronous and $optionDataContract and $optionClientProxy">
    ...
    public class <xsl:value-of select="name"/>Client : Global.System.ServiceModel.ClientBase&lt;I<xsl:value-of select="name"/>&gt;, I<xsl:value-of select="name"/>
    {
